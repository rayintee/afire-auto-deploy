 ...
 * @Date: 2020-08-28 19:49:18
 * @LastEditTime: 2020-08-29 14:43:21
 * @LastEditors: Please set LastEditors
 * @Description: 读取配置文件
 * @FilePath: /afire-auto-deploy/src/readConfig.js
 */
 ...
 * @param sectionName
 */
ReadConf.prototype.removeSection = function (sectionName) {
 ...
 * @type {Function}
 */
ReadConf.prototype.getOrCreateSection = ReadConf.prototype.section = function (sectionName) {
 ...
 * @returns {string}
 */
ReadConf.prototype.encodeToIni = ReadConf.prototype.toString = function encodeIni() {
    var _INI = this;
 ...
 * @returns {string}
 */
ReadConf.prototype.encodeSection = function (section, obj) {
    var out = "";
    Object.keys(obj).forEach(function (k, _, __) {
        ...
        } else if (val && typeof val === "object") {} else {
 ...
 * @type {Function}
 */
exports.createReadConf = exports.create = function () {
    return new ReadConf();
};
