 ...
 * @LastEditTime: 2020-09-25 13:55:25
...
class UploadClient {
     ...
     * @param {*} deploy_path 
     */
    constructor(options, deploy_path, rmdir_all = false, errHandler) {
    ...
    deploy(filesList = []) {
        try {
            ...
            this.sftp.connect(this.serverOptions).then(() => {
                    return this.initDir(this.deployPath, this.rmdirAll);
                }).then(data => {
